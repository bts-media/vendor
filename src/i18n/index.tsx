...
export const translateData: ITranslateData = {
    ...
    channel_none: {
        uz: "Faqat qo'lda joylashtirish",
        ru: 'Только ручное размещение',
        en: 'Manual placements only',
    },
    channel_none_desc: {
        uz: "Kartochka, banner, sayt, Telegram, ilova, Instagram — platforma yetkazmaydi, faqat hisobga oladi",
        ru: 'Карточка, баннер, сайт, Telegram, приложение, Instagram — платформа не доставляет, только учитывает',
        en: 'Card, banner, website, Telegram, app, Instagram — the platform bills these but does not deliver them',
    },
    ...
    campaign_updated: { uz: 'Kampaniya yangilandi', ru: 'Кампания обновлена', en: 'Campaign updated' },
    campaign_created: {
    ...
    est_banner: {
        uz: "Posilkalar uchun faqat tasdiqlangan ko'rsatishlarga to'laysiz. Belgilangan o'rinlar ishga tushirishda bir marta to'lanadi.",
        ru: 'За посылки вы платите только за подтверждённые показы. Фиксированные размещения оплачиваются один раз при запуске.',
        en: 'Parcels are billed only on verified impressions. Flat placements are charged once at launch.',
    },
    ...
    // ===== Joylashtirishlar =====
    step_placements: { uz: 'Joylashtirishlar', ru: 'Размещения', en: 'Placements' },
    placements_title: {
        uz: 'Kampaniya nimani sotib oladi?',
        ru: 'Что покупает кампания?',
        en: 'What does the campaign buy?',
    },
    placements_sub: {
        uz: "O'rinlar va miqdorlar — narx BTS narxlar jadvalidan olinadi",
        ru: 'Размещения и количества — цена берётся из прайс-листа BTS',
        en: 'Placements and quantities — prices come from the BTS rate card',
    },
    placements_required: {
        uz: "Kamida bitta o'rin qo'shing",
        ru: 'Добавьте хотя бы одно размещение',
        en: 'Add at least one placement',
    },
    placement: { uz: "O'rin", ru: 'Размещение', en: 'Placement' },
    add_placement: { uz: "O'rin qo'shish", ru: 'Добавить размещение', en: 'Add placement' },
    placement_PARCEL_STICKER: { uz: 'Posilka stikeri', ru: 'Стикер на посылке', en: 'Parcel sticker' },
    placement_PARCEL_BOX: { uz: 'Brendlangan quti', ru: 'Брендированная коробка', en: 'Branded box' },
    placement_SCREEN_TV: { uz: 'Filial televizori', ru: 'ТВ в филиале', en: 'Branch TV' },
    placement_COUNTER_CARD: { uz: 'Peshtaxta kartochkasi', ru: 'Карточка на стойке', en: 'Counter card' },
    placement_ROLLUP_BANNER: { uz: 'Roll-ap banner', ru: 'Ролл-ап баннер', en: 'Roll-up banner' },
    placement_WEBSITE_BANNER: { uz: 'Veb-sayt banneri', ru: 'Баннер на сайте', en: 'Website banner' },
    placement_TELEGRAM_POST: { uz: 'Telegram post', ru: 'Пост в Telegram', en: 'Telegram post' },
    placement_APP_HOME: { uz: 'Mobil ilova — bosh ekran', ru: 'Приложение — главный экран', en: 'App home' },
    placement_APP_STORY: { uz: 'Mobil ilova — storis', ru: 'Приложение — сторис', en: 'App story' },
    placement_APP_PUSH: { uz: 'Mobil ilova — push', ru: 'Приложение — push', en: 'App push' },
    placement_INSTAGRAM_REEL: { uz: 'Instagram — rils', ru: 'Instagram — рилс', en: 'Instagram reel' },
    placement_INSTAGRAM_STORY: { uz: 'Instagram — storis', ru: 'Instagram — сторис', en: 'Instagram story' },
    quantity: { uz: 'Miqdor', ru: 'Количество', en: 'Quantity' },
    unit_CPM: { uz: "ming ko'rsatish", ru: 'тыс. показов', en: 'k impressions' },
    unit_PER_PARCEL_WEIGHT: { uz: 'posilka', ru: 'посылка', en: 'parcel' },
    unit_PER_BRANCH_MONTH: { uz: 'filial-oy', ru: 'филиал-месяц', en: 'branch-month' },
    unit_PER_MONTH: { uz: 'oy', ru: 'месяц', en: 'month' },
    unit_PER_POST: { uz: 'post', ru: 'пост', en: 'post' },
    parcel_qty_note: {
        uz: "= ko'rsatishlar maqsadi",
        ru: '= цель по показам',
        en: '= impression goal',
    },
    branch_group: { uz: 'Filial guruhi', ru: 'Группа филиалов', en: 'Branch group' },
    branch_group_TASHKENT: { uz: 'Toshkent', ru: 'Ташкент', en: 'Tashkent' },
    branch_group_OBLAST: { uz: 'Viloyat markazi', ru: 'Областной центр', en: 'Oblast centre' },
    branch_group_REGION: { uz: 'Hudud', ru: 'Район', en: 'Region' },
    package: { uz: 'Paket', ru: 'Пакет', en: 'Package' },
    package_none: { uz: 'Paketsiz', ru: 'Без пакета', en: 'No package' },
    package_ECONOM: { uz: 'Econom', ru: 'Econom', en: 'Econom' },
    package_OPTIMUM: { uz: 'Optimum', ru: 'Optimum', en: 'Optimum' },
    package_PREMIUM: { uz: 'Premium', ru: 'Premium', en: 'Premium' },
    package_includes: { uz: 'Kiradi', ru: 'Входит', en: 'Includes' },
    package_note: {
        uz: "Paketga kiradigan o'rinlar 1 donadan avtomatik qo'shiladi, chegirma barcha belgilangan qatorlarga qo'llanadi. Posilka stikeri paketga kirmaydi.",
        ru: 'Размещения пакета добавляются автоматически по 1 шт., скидка применяется ко всем фиксированным строкам. Стикер на посылке в пакет не входит.',
        en: 'Package placements are added automatically at quantity 1; the discount applies to every flat line. The parcel sticker is never part of a package.',
    },
    package_needs_screen: {
        uz: 'Televizorli paket uchun ekran kanali kerak',
        ru: 'Пакет с ТВ требует канал экранов',
        en: 'A package with TV needs the screen channel',
    },
    unit_price: { uz: 'Birlik narxi', ru: 'Цена за единицу', en: 'Unit price' },
    surcharge: { uz: "Qo'shimcha to'lov", ru: 'Доплата', en: 'Surcharge' },
    amount: { uz: 'Summa', ru: 'Сумма', en: 'Amount' },
    unpriced: { uz: 'Narx belgilanmagan', ru: 'Цена не задана', en: 'Not priced' },
    flat_total: {
        uz: "Belgilangan to'lovlar",
        ru: 'Фиксированные платежи',
        en: 'Flat fees',
    },
    parcel_estimate: { uz: 'Posilka prognozi', ru: 'Прогноз по посылкам', en: 'Parcel estimate' },
    discount: { uz: 'Chegirma', ru: 'Скидка', en: 'Discount' },
    estimate_live_note: {
        uz: 'Narxlar jonli — ishga tushirishda muzlatiladi',
        ru: 'Цены актуальные — фиксируются при запуске',
        en: 'Live prices — frozen at launch',
    },
    estimate_frozen_note: {
        uz: "Ishga tushirilgan — narxlar muzlatilgan, joylashtirishlar endi o'zgartirilmaydi",
        ru: 'Запущена — цены зафиксированы, размещения больше не меняются',
        en: 'Launched — prices are frozen and placements can no longer be changed',
    },
    campaign_detail: { uz: 'Kampaniya tafsiloti', ru: 'Детали кампании', en: 'Campaign detail' },
    campaign_not_found: { uz: 'Kampaniya topilmadi', ru: 'Кампания не найдена', en: 'Campaign not found' },
    edit_placements: {
        uz: 'Joylashtirishlarni tahrirlash',
        ru: 'Изменить размещения',
        en: 'Edit placements',
    },
    edit_locked_note: {
        uz: 'Joylashtirishlar faqat tasdiqdan oldin tahrirlanadi',
        ru: 'Размещения можно менять только до подтверждения',
        en: 'Placements can be edited only before approval',
    },
    invoice_lines: { uz: 'Hisob-faktura qatorlari', ru: 'Строки счёта', en: 'Invoice lines' },

    // Backend xato kodlari
    err_MIN_PARCEL_ORDER_NOT_MET: {
        uz: 'Posilka kampaniyasi kamida 10 000 posilka buyurtma qiladi',
        ru: 'Кампания на посылках заказывает не меньше 10 000 посылок',
        en: 'A parcel campaign orders at least 10,000 parcels',
    },
    err_PRICING_NOT_CONFIGURED: {
        uz: "Tanlangan o'rinlardan birining narxi hali belgilanmagan — BTS bilan bog'laning",
        ru: 'Для одного из размещений ещё не задана цена — свяжитесь с BTS',
        en: 'One of the selected placements has no price yet — contact BTS',
    },
    err_CAMPAIGN_PLACEMENTS_FROZEN: {
        uz: "Kampaniya ishga tushirilgan — joylashtirishlar endi o'zgartirilmaydi",
        ru: 'Кампания запущена — размещения больше не меняются',
        en: 'The campaign is launched — placements can no longer be changed',
    },
    err_INSUFFICIENT_BALANCE: {
        uz: "Balans yetarli emas — belgilangan to'lovlar va kamida bitta posilka uchun mablag' kerak",
        ru: 'Недостаточно баланса — нужны средства на фиксированные платежи и хотя бы одну посылку',
        en: 'Insufficient balance — the flat fees plus at least one parcel must be covered',
    },
    err_CREDIT_LIMIT_EXCEEDED: {
        uz: 'Kredit limiti oshib ketadi',
        ru: 'Превышен кредитный лимит',
